...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_218905669";//发送短信验证码
	//public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "yt_health";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI5t5kwRawZ8mLNbDTnNXG"; //你的AccessKey ID
	private static final String SECRET_KEY="8iGTOdsNIcpexHRRhYIXRia6F4CqBD"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		//SMSUtils.sendShortMessage(VALIDATE_CODE,"13652431027","666666");
		System.out.println(String.format("{\"%s\":\"%s\"}", PARAMETER_NAME, "123456"));
	}
