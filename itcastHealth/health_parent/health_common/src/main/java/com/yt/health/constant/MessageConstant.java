package com.yt.health.constant;

/**
 * 包名：com.yt.health.constant
 *
 * @author Yangtao
 * 日期：2021-06-15  01:20
 */
public interface MessageConstant {
    static final String EDIT_COMBO_SUCCESS = "更新套餐成功";
    static final String DELETE_COMBO_SUCCESS = "删除套餐成功";
    ...
    String CHECKGROUP_IN_USE ="当前检查组存在关联";
